export async function up(pgm) {
  pgm.sql(`
    ...
    create index if not exists users_coach_id_idx on users(coach_id) where coach_id is not null;
    create index if not exists workout_laps_workout_id_idx on workout_laps(workout_id);
  `);
}
