      ...
      <section className="card">
        <div className="section-header">
          <div>
            ...
            <p className="muted">Только новые тренировки после привязки Strava</p>
          </div>
        ...
        <div className="grid three-columns">
          <StatCard label="Страва" value={data?.athlete.connected_at ? "Подключена" : "Не подключена"} />
          <StatCard label="Последняя синхронизация" value={data?.athlete.last_synced_at ? formatDate(data.athlete.last_synced_at) : "Еще не было"} />
          <StatCard label="Последняя тренировка" value={latest ? formatDate(latest.start_date) : "Нет данных"} />
        </div>
      </section>
